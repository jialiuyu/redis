...
> 中文版架构文档，供开发者阅读。英文 agent 版本见 `architecture.md`（已加入 opencodeignore 节省 token）。
...
### 文档
`AGENTS.md` · `CLAUDE.md` · `BUILD_GUIDE.md` · `WORK_COMPLETED.md` · `THREE_LAYER_BENCHMARK_GUIDE.md` · `V10_BENCHMARK_REPORT.md` · `README_UB_SVE.md` · `QUICKSTART_UB_SVE.md` · `architecture.md`(英文 agent 版) · `architecture_CN.md`(本文件)