...
protected:
    ...
    int m_key_len;
    char *m_value_buffer;
    float *m_vector_buffer;
    uint32_t m_vector_dim;
    int m_random_fd;
...
public:
    ...
    void set_vector_dim(uint32_t dim);
    ...
    void set_key_zipfian(double s);
    unsigned long long zipfian_distribution(unsigned long long min, unsigned long long max, double s);
