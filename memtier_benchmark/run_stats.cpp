...
inline timeval timeval_factorial_average(timeval a, timeval b, unsigned int weight)
{
    ...
    double a_usec = (double)a.tv_sec * 1000000.0 + (double)a.tv_usec;
    double b_usec = (double)b.tv_sec * 1000000.0 + (double)b.tv_usec;
    double result_usec = factor * a_usec + b_usec / weight;
    tv.tv_sec = (long)(result_usec / 1000000.0);
    tv.tv_usec = (long)(result_usec - (double)tv.tv_sec * 1000000.0);
    return (tv);
}
...
void run_stats::merge(const run_stats& other, int iteration)
{
    ...
    m_n_merged++;
    m_start_time = timeval_factorial_average( m_start_time, other.m_start_time, m_n_merged );
    m_end_time =   timeval_factorial_average( m_end_time,   other.m_end_time,   m_n_merged );
