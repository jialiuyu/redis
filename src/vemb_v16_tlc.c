...
int vemb_v16_tlc_get_handle_hint(vemb_v16_tlc_t *tlc,
                                 ...
                                 uint32_t *warm_slot) {
    tlc_warm_location_t location = {0};
    if (tlc_core_get_warm_location_hint(tlc->core, key, key_len,
                                        key_hash, &location) != 0) {
        return -1;
    }
    if (warm_slot) *warm_slot = location.local_slot;
...
int vemb_v16_tlc_lookup_vsim_key2(vemb_v16_tlc_t *tlc,
    ...
    *source = VEMB_V16_TLC_LOOKUP_SOURCE_NONE;
    ...
    if (vemb_v16_tlc_get_handle_hint(tlc,
                                     key2,
                                     key2_len,
                                     key2_hash,
                                     handle,
...
void vemb_v16_tlc_get_runtime_stats(vemb_v16_tlc_t *tlc,
    ...
    stats->ub_lookup_rpc_count = 0;
    stats->ub_lookup_rpc_ok = 0;
    stats->ub_lookup_rpc_not_found = 0;
    stats->ub_lookup_rpc_busy = 0;
    stats->ub_lookup_rpc_timeout = 0;
    stats->ub_lookup_rpc_error = 0;
    stats->ub_lookup_rpc_handle = 0;
    stats->ub_lookup_rpc_snapshot = 0;
    stats->ub_lookup_rpc_ns = 0;
